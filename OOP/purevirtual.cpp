...
class Car {         // class with at least one pure virtual function is called abstract class 
    ...
    public:
     ...
     virtual void messege () = 0;   // pure virtual function, function of this name will must be initialized in derived classes
